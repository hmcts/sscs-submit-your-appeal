...
const configureNunjucks = (app, commonContent) =>
  ...
  expressNunjucks(app, {
    ...
    globals: {
      ...
      kerv: {
        deploymentId: {
            en: config.get('services.webchat.kerv.deploymentId.en'),
            cy: config.get('services.webchat.kerv.deploymentId.cy'),
        },
        genesysBaseUrl: config.get('services.webchat.kerv.genesysBaseUrl'),
        environment: config.get('services.webchat.kerv.environment'),
        kervBaseUrl: config.get('services.webchat.kerv.kervBaseUrl'),
        apiKey: config.get('services.webchat.kerv.apiKey'),
      },
      paths,
      urls,
  ...
  app.use(helmet.contentSecurityPolicy({
    directives: {
      ...
      scriptSrc: [
        ...
        `${config.services.webchat.kerv.genesysBaseUrl}`,
      ],
      connectSrc: [
        '\'self\'',
        'www.gov.uk',
        ...
        'vcc-eu4-cf.8x8.com',
        `${config.services.webchat.kerv.kervBaseUrl}`,
