...
const configureNunjucks = (app, commonContent) =>
  ...
  expressNunjucks(app, {
    ...
    globals: {
      ...
      kerv: {
        deploymentId: {
            en: config.services.kerv.deploymentId.en,
            cy: config.services.kerv.deploymentId.cy,
        },
        genesysBaseUrl: config.services.kerv.genesysBaseUrl,
        environment: config.services.kerv.environment,
        kervBaseUrl: config.services.kerv.kervBaseUrl,
        apiKey: config.services.kerv.apiKey,
      },
      paths,
      urls,
