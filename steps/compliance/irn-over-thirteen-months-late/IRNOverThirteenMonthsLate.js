...
class IRNOverThirteenMonthsLate extends SaveToDraftStore {
  static get path() {
    return paths.compliance.irnOverThirteenMonthsLate;
  }
  ...
  next() {
    return goTo(this.journey.steps.AppellantRole);
  }
}

module.exports = IRNOverThirteenMonthsLate;
