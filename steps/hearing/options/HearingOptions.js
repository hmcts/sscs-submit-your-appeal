...
class HearingOptions extends SaveToDraftStore {
    ...
    values() {
        const selectOptions = this.fields.selectOptions;
        const telephoneSelected = !!selectOptions.telephone.requested.value;
        const videoSelected = !!selectOptions.video.requested.value;
        const f2fSelected = !!selectOptions.faceToFace.requested.value;
