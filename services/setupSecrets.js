...
const setupSecrets = () => {
  if (config.has('secrets.sscs')) {
    ...
    setSecret(
      'secrets.sscs.webchat-kerv-deployment-en',
      'services.kerv.deploymentId.en'
    );
    setSecret(
      'secrets.sscs.webchat-kerv-deployment-cy',
      'services.kerv.deploymentId.cy'
    );
    setSecret(
      'secrets.sscs.webchat-kerv-genesys-base-url',
      'services.kerv.genesysBaseUrl'
    );
    setSecret(
