...
describe('cyaHearingArrangementsUtils.js', () => {
    ...
    describe('setCYAValue', () => {
        ...
        it('should return Required when the arrangementValue equals Required and hiddenFieldValue is undefined', () => {
            expect(setCYAValue(REQUIRED, undefined)).to.equal(REQUIRED);
        });

        it('should return Required when the arrangementValue equals Required and hiddenFieldValue is an empty string', () => {
            expect(setCYAValue(REQUIRED, '')).to.equal(REQUIRED);
        });

        it('should return the hidden field value when the arrangementValue equals Required and hiddenFieldValue is set', () => {
