...
describe('SmsConfirmation.js', () => {
    ...
    describe('get mobileNumber()', () => {
        ...
        it('should return enterMobile when the appellantPhoneNumber is an empty string', () => {
            ...
            expect(smsConfirmation.mobileNumber).to.eq(formatMobileNumber(smsConfirmation.fields.enterMobile.value));
        });
        ...
        it('should return appellantPhoneNumber which is a mobile', () => {
            ...
            expect(smsConfirmation.mobileNumber).to.eq(formatMobileNumber(smsConfirmation.fields.phoneNumber.value));
        });
