...
Scenario('Provides date of when they cannot attend the hearing', I => {
...
Scenario('Provides a single date when they cannot attend the hearing, then edits the date', I => {
