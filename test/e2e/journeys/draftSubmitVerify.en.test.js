...
const { checkYourAppealToConfirmationPage, continueIncompleteAppeal, enterDetailsFromStartToDraft } = require('../page-objects/cya/checkYourAppeal');
...
const { checkOptionAndContinueAfterSignIn, checkOptionAndContinueAfterSignIn } = require('../page-objects/controls/option');
const {
