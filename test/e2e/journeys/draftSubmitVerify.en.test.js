...
test.describe(`${language.toUpperCase()} - Verifying data when drafts are submitted to CCD`, () => {
  ...
  test(`${language.toUpperCase()} - Sign in and submit draft appeal and verify the submitted CCD`, { tag: '@fullFunctional-wip' },
  ...
  // pass undefined for mobileNumber to use default, then pass userEmail for the email field
