...
async function selectAreYouProvidingEvidenceAndContinue(I, language, commonContent, option) {
...
async function selectAreYouProvidingEvidenceAfterSignIn(I, language, commonContent, option) {
  const evidenceUploadContent = language === 'en' ? evidenceUploadContentEn : evidenceUploadContentCy;
