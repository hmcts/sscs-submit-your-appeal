...
async function selectHaveYouGotAMRNAndContinue(I, language, commonContent, option) {
...
async function selectHaveYouGotAMRNAndContinueAfterSignIn(I, language, commonContent, option) {
  const haveMRNContent = language === 'en' ? haveMRNContentEn : haveMRNContentCy;
