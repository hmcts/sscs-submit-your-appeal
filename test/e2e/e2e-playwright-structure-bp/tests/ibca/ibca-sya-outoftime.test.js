...
async function runAssertions(ibcaPageObject) {
  ...
  ibcaPageObject.defaultPageContent.bodyContents.forEach(bodyContent => expect(ibcaPageObject.page.locator(ibcaPageObject.body)).toContainText(bodyContent));
}
...
[
  ...
  test(`testing end to end ibca journey for ref. num predated by ${refNumPredatedBy} month(s) scenario`, { tag: '@ibca' }, async({ page }) => {
