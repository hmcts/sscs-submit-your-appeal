...
test.describe(`${language.toUpperCase()} - Enter Mobile`, { tag: '@batch-11' }, () => {
  ...
  test(`${language.toUpperCase()} - When page enter a valid mobile number, page am taken to the sms-confirmation page`, async({ page }) => {
