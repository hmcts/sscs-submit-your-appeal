...
test.describe(`${language.toUpperCase()} - Appellant Name form`, { tag: '@batch-09' }, () => {
  ...
  test(`${language.toUpperCase()} - When page fill in the fields and click Continue, page am taken to /enter-appellant-dob`, async({ page }) => {
