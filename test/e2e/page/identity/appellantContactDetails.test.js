...
const appellantContactDetailsContentEn = require('steps/identity/appellant-contact-details/content.en');
const appellantContactDetailsContentCy = require('steps/identity/appellant-contact-details/content.cy');
