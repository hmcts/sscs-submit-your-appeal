...
test.describe(`${language.toUpperCase()} - MRN Over one month late`, { tag: '@batch-07' }, () => {
  ...
  test('MRN is over one month late, page do not enter a reason, page see errors', async({ page }) => {
    await page.getByRole('button', { name: commonContent.continue }).first().click();
