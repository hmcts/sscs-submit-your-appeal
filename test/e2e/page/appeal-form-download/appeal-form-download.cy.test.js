...
test.describe(`${language.toUpperCase()} - Appeal form download page @batch-06`, () => {
  ...
  test(`${language.toUpperCase()} - I see SSCS1 content when not selecting Carer's Allowance or CBLP`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - I see SSCS5 content when I select CBLP as a benefit type`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - I see SSCS2 content when I select Child support as a benefit type`, async({ page }) => {
