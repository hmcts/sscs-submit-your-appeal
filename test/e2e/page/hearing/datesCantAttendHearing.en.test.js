...
test.describe(`${language.toUpperCase()} - Dates can't attend`, { tag: '@batch-08' }, () => {
  ...
  test(`${language.toUpperCase()} - When page go to the page and there are no dates page see the Add date link`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - When page click the Add date link, page go to the page where page can enter dates`, async({ page }) => {
    await expect(page.getByText(datesCantAttendContent.noDates).first()).toBeVisible();
  ...
  test(`${language.toUpperCase()} - When page add a date page see the date in the list`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - When page add a date page see the add another date link`, async({ page }) => {
    await enterDateCantAttendAndContinue(page, commonContent, validDate, datesCantAttendContent.links.add);
    await expect(page.getByText(datesCantAttendContent.links.addAnother).first()).toBeVisible();
  });

  test(`${language.toUpperCase()} - When page add multiple dates, page see them in the list`, async({ page }) => {
    await enterDateCantAttendAndContinue(page, commonContent, validDate, datesCantAttendContent.links.add);
  ...
  test(`${language.toUpperCase()} - When page add a date and click the delete link, the date is removed`, async({ page }) => {
    await enterDateCantAttendAndContinue(page, commonContent, validDate, datesCantAttendContent.links.add);
    await seeFormattedDate(page, validDate);
  ...
  test(`${language.toUpperCase()} - page add a single date, page remove it, page see Add date`, async({ page }) => {
    await enterDateCantAttendAndContinue(page, commonContent, validDate, datesCantAttendContent.links.add);
    await expect(page.getByText(datesCantAttendContent.links.addAnother).first()).toBeVisible();
    await page.getByText(commonContent.delete).first().click();
    await expect(page.getByText(datesCantAttendContent.links.addAnother).first()).toBeHidden();
    await expect(page.getByText(datesCantAttendContent.links.add).first()).toBeVisible();
  });

  test(`${language.toUpperCase()} - When page click Continue without add a date, page see errors`, async({ page }) => {
    await page.getByRole('button', { name: commonContent.continue }).first().click();
    await expect(page.getByText(datesCantAttendContent.noDates).first()).toBeVisible();
  });

  test(`${language.toUpperCase()} - When page add a date and the edit it, page see the new date`, async({ page }) => {
    await enterDateCantAttendAndContinue(page, commonContent, validDate, datesCantAttendContent.links.add);
    await seeFormattedDate(page, validDate);
  ...
  test(`${language.toUpperCase()} - When page click Continue without filling in the date fields, page see errors`, async({ page }) => {
    await page.getByText(datesCantAttendContent.links.add).first().click();
    await page.getByRole('button', { name: commonContent.continue }).first().click();
  ...
  test(`${language.toUpperCase()} - When page click Continue when only entering the day field, page see errors`, async({ page }) => {
    await page.getByText(datesCantAttendContent.links.add).first().click();
    await page.locator('input[name*="day"]').first().fill(validDate.date().toString());
    await page.getByRole('button', { name: commonContent.continue }).first().click();
  ...
  test(`${language.toUpperCase()} - When page click Continue when only entering the month field, page see errors`, async({ page }) => {
    await page.getByText(datesCantAttendContent.links.add).first().click();
    await page.locator('input[name*="month"]').first().fill((validDate.month() + 1).toString());
    await page.getByRole('button', { name: commonContent.continue }).first().click();
  ...
  test(`${language.toUpperCase()} - When page click Continue when only entering the year field, page see errors`, async({ page }) => {
    await page.getByText(datesCantAttendContent.links.add).first().click();
    await page.locator('input[name*="year"]').first().fill(validDate.year().toString());
    await page.getByRole('button', { name: commonContent.continue }).first().click();
    await expect(page.getByText(datesCantAttendContent.fields.cantAttendDate.error.dayRequired).first()).toBeVisible();
    await expect(page.getByText(datesCantAttendContent.fields.cantAttendDate.error.monthRequired).first()).toBeVisible();
  });

  test(`${language.toUpperCase()} - When page enter a date that is under four weeks from now, page see errors`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - When page enter a date that is over twenty two weeks from now, page see errors`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - page enter a date page cant attend with the long name of month`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - page enter a date page cant attend with the short name of month`, async({ page }) => {
  ...
  test(`${language.toUpperCase()} - page enter a date page cant attend with an invalid name of month`, async({ page }) => {
    await page.getByText(datesCantAttendContent.links.add).first().click();
