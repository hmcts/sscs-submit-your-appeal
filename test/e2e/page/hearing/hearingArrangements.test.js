...
Scenario('I select language interpreter and do not enter any language I see errors', I => {
  I.click(fields.selection.languageInterpreter.requested.label);
  I.click(Continue);
  I.see(fields.selection.languageInterpreter.language.error.required);
});

Scenario('I select a language interpreter, enter a non-existent list language, I see errors', I => {
  I.click(fields.selection.languageInterpreter.requested.label);
...
Scenario('I select sign language and do not enter any language I see errors', I => {
  I.click(fields.selection.signLanguage.requested.label);
  I.click(Continue);
  I.see(fields.selection.signLanguage.language.error.required);
});

Scenario('Select sign language and enter a language that is not on the list I see errors', I => {
  I.click(fields.selection.signLanguage.requested.label);
...
Scenario('I select anything else and don\'t enter any thing into the field I see errors', I => {
  I.click(fields.selection.anythingElse.requested.label);
  I.click(Continue);
  I.see(fields.selection.anythingElse.language.error.required);
});

Scenario('I select anything else and enter illegal characters in the field I see errors', I => {
  I.click(fields.selection.anythingElse.requested.label);
