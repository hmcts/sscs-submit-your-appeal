...
test.describe(`${language.toUpperCase()} - Representative @batch-10`, () => {
  ...
  test(`${language.toUpperCase()} - When I select yes, I am taken to the representative details page`, async({
    page
  }) => {
  ...
  test(`${language.toUpperCase()} - When I select No, I am taken to the reason for appealing page`, async({
    page
  }) => {
    await selectDoYouHaveARepresentativeAndContinue(
      page,
