...
test.describe(
  ...
  () => {
    ...
    test(`${language.toUpperCase()} - When page click continue without filling in the fields page see errors`, async({
      ...
      await expect(
        page
          .getByText(representativeDetailsContent.fields.name.error.required)
          .first()
      ).toBeVisible();
      await expect(
        page
      ...
      await expect(
        page
          .getByText(representativeDetailsContent.fields.county.error.required)
          .first()
      ).toBeVisible();
      await expect(
        page
    ...
    test(`${language.toUpperCase()} - When page enter an organisation and continue, page do not see errors`, async({
      ...
      await page
        .locator('input[name="name.organisation"]')
        .first()
        .fill('Hogwarts');
      await page
        .getByRole('button', { name: commonContent.continue })
